...
const VIX_LEVEL_LABEL: Record<string, string> = {
  low: '低波动',
  medium: '中等波动',
  high: '高波动',
  extreme: '极端波动',
...
const VOL_LEVEL_LABEL: Record<string, string> = {
  shrink: '缩量',
  normal: '正常',
  expand: '放量',
  surge: '巨量',
  ...
  if (loading && !data) {
    return (
      <div className="st-page">
        <div className="st-page__header"><h2 className="st-page__title">市场情绪仪表盘</h2></div>
      ...
      <div className="st-grid">
        ...
        {data.vix && (
          <div className="st-card">
            ...
            <div className={`st-vix st-vix--${data.vix.level}`}>
              ...
              <div className={`st-vix__change ${data.vix.change >= 0 ? 'st-vix__change--up' : 'st-vix__change--down'}`}>
            ...
            <div className="st-vix__scale">
              <div className="st-vix__scale-bar">
                <div className="st-vix__scale-marker" style={{ left: `${Math.min(100, (data.vix.current / 40) * 100)}%` }} />
              </div>
          ...
          <div className="st-breadth">
            <div className="st-breadth__row">
              ...
              <div className="st-breadth__bar">
                <div className="st-breadth__bar-up" style={{ width: `${data.breadth.advanceRatio}%` }} />
              </div>
              <span className="st-breadth__val st-breadth__val--down">{data.breadth.decliners}</span>
            ...
            <div className="st-breadth__stats">
              <div className="st-breadth__stat">
                ...
                <span className="st-breadth__stat-val">{data.breadth.aboveMa50Pct.toFixed(0)}%</span>
              </div>
              <div className="st-breadth__stat">
                <span className="st-breadth__stat-label">创新高</span>
                <span className="st-breadth__stat-val st-breadth__stat-val--up">{data.breadth.newHighs}</span>
              </div>
              <div className="st-breadth__stat">
                <span className="st-breadth__stat-label">创新低</span>
                <span className="st-breadth__stat-val st-breadth__stat-val--down">{data.breadth.newLows}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="st-card">
          ...
          <div className="st-volume">
            ...
            <div className="st-volume__avg">
              均量: {formatVolume(data.volume.avgVolume)}
            </div>
          </div>
        </div>
      </div>
